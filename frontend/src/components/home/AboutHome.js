        ...
        <div className="about-home-row">
          ...
          <div className="about-home-col about-home-content">
            <div className="about-home-section-title">
              ...
              <p>At our institution, we are committed to delivering high-quality education that empowers students to develop their skills and enhance their knowledge.</p>
            </div>
            ...
            <div className="about-home-body">
              ...
              <div className="about-home-list-item">
                ...
                <div className="about-home-list-content">
                  ...
                  <p>Our institution provides comprehensive resources, including notes and recorded classes, ensuring you have access to trusted educational materials for your learning.</p>
                </div>
              </div>
            </div>
